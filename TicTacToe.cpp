...
#define COMPUTER 1
#define HUMAN 2
#define SIDE 3 // 3x3 Tic-Tac-Toe board
...
// Function to show instructions on how to play
...
// Check if the game is over either by row, column, or diagonal crossing
